  ...
  return (
    ...
    return (
        <div className="max-w-3xl space-y-8 md:space-y-12">
            {/* Title Section */}
            <div>
                <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-white mb-2">Smooth Hover</h1>
            ...
            <div className="space-y-4">
                ...
                <div className="border border-white/[0.08] rounded-xl overflow-hidden bg-[#0a0a0a]">
                    {activeTab === 'preview' ? (
                        <div className="min-h-[300px] md:h-[400px] flex items-center justify-center relative bg-[#111]">
...
function HoverDemo() {
    ...
    return (
        <div
            ...
            style={style}
            {...bind}
            className="p-6 md:p-8 bg-white rounded-xl w-full max-w-[280px] md:w-64 cursor-pointer mx-4"
        >
            <div className="w-10 h-10 md:w-12 md:h-12 bg-black rounded-full flex items-center justify-center text-white mb-4 md:mb-6">
                <ArrowUpRight className="w-5 h-5 md:w-6 md:h-6" />
            </div>

            <h3 className="text-black font-bold text-lg md:text-xl mb-2">Minimalist</h3>
