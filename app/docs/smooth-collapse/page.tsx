  ...
  return (
    ...
    return (
        <div className="max-w-3xl space-y-8 md:space-y-12">
            {/* Title Section */}
            <div>
                <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-white mb-2">Smooth Collapse</h1>
            ...
            <div className="space-y-4">
                ...
                <div className="border border-white/[0.08] rounded-xl overflow-hidden bg-[#0a0a0a]">
                    {activeTab === 'preview' ? (
                        <div className="min-h-[300px] md:h-[400px] flex items-center justify-center relative bg-black/50 p-4 md:p-8">
                            {/* Live Accordion Demo */}
                            <CollapseDemo />
                        </div>
                    ) : (
    ...
    return (
        <div className="w-full max-w-md mx-4">
            <div className="border border-white/[0.08] rounded-lg overflow-hidden bg-[#111]">
                <button
                    onClick={toggle}
                    className="w-full flex items-center justify-between p-3 md:p-4 text-left font-medium text-white hover:bg-white/5 transition-colors text-sm md:text-base"
                >
                    <span>Why use SmoothKit?</span>
                    <ChevronDown
                        className={`w-4 h-4 md:w-5 md:h-5 text-white/40 transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}
                    />
                </button>

                <div ref={ref} style={style}>
                    <div className="p-3 md:p-4 pt-0 text-white/60 text-xs md:text-sm leading-relaxed border-t border-white/[0.08]">
