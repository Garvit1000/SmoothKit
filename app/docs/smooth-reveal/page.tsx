  ...
  return (
    ...
    return (
        <div className="max-w-3xl space-y-12">
            {/* Title Section */}
            <div>
                <h1 className="text-3xl font-bold tracking-tight text-white mb-2">Smooth Reveal</h1>
            ...
            <div className="space-y-4">
                ...
                <div className="border border-white/[0.08] rounded-xl overflow-hidden bg-[#050505]">
                    {activeTab === 'preview' ? (
                        <div className="h-[450px] flex items-center justify-center relative bg-[url(https://grainy-gradients.vercel.app/noise.svg)]">
    ...
    return (
        <div className={cn("flex w-full", align === 'right' ? "justify-end" : "justify-start")}>
            <div
                ...
                className={cn(
                    "max-w-[80%] p-4 rounded-2xl shadow-lg border backdrop-blur-sm",
                    variant === 'primary'
