...
function CounterDisplay() {
    ...
    return (
        <div className="text-center space-y-4">
            <div className="text-7xl font-bold text-white tracking-tighter tabular-nums text-transparent bg-clip-text bg-gradient-to-b from-white to-white/50">
  ...
  return (
    ...
    return (
        <div className="max-w-3xl space-y-12">
            {/* Title Section */}
            <div>
                <h1 className="text-3xl font-bold tracking-tight text-white mb-2">Smooth Counter</h1>
            ...
            <div className="space-y-4">
                ...
                <div className="border border-white/[0.08] rounded-xl overflow-hidden bg-[#0a0a0a]">
                    {activeTab === 'preview' ? (
                        <div className="h-[350px] flex items-center justify-center relative bg-black/50 overflow-hidden group">
